...
public class DrawerTableScreen extends AbstractContainerScreen<DrawerTableMenu>
{
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(RenderType::guiTextured, CONTAINER_BACKGROUND, i, j, 0.0F, 0.0F, this.imageWidth, 125, 256,
                         256
        );
        guiGraphics.blit(RenderType::guiTextured, CONTAINER_BACKGROUND, i, j + 125, 0.0F, 126.0F, this.imageWidth, 96,
                         256, 256
        );
    }
}
