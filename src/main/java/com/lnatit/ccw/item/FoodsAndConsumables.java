...
public class FoodsAndConsumables
{
    ...
    public static final Consumable VOID_CARROT_CONSUMABLE = Consumables.defaultFood().build();
    ...
    public static final Consumable IRON_CLAD_APPLE_CONSUMABLE = Consumables.defaultFood().build();
    ...
    public static final Consumable GOLD_STUDDED_APPLE_CONSUMABLE = Consumables.defaultFood().build();
    ...
    public static final Consumable BLESSED_STEAK_CONSUMABLE = Consumables.defaultFood().build();
    ...
    public static final Consumable DOLPHIN_COOKIE_CONSUMABLE = Consumables.defaultFood().build();
}
